...
@section('content')
    ...
    <div class="card">
            <div class="card-body">
                <form class="form" action="{{ route('barangs.update', $barang->id) }}" method="POST"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" class="form-control" id="price"
                                           placeholder="Masukkan harga menu" value="{{ old('price', $barang->latestPrice->harga) }}"
                                           required>
                                    @error('price')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control" required>
                                        ...
                                        @foreach ($categories as $category)
                                            <option
                                                value="{{ $category->id }}" {{ old('category_id', $barang->category_id) == $category->id ? 'selected' : '' }}>{{ $category->nama_kategori }}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ukuran" class="form-control" id="ukuran"
                                           ...
                                           value="{{ old('ukuran', $barang->ukuran) }}" required>
                                    @error('ukuran')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="warna" class="form-control" id="warna"
                                           placeholder="Masukkan ukuran barang"
                                           value="{{ old('warna', $barang->warna) }}" required>
                                    @error('warna')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="stok" class="form-control" id="stok"
                                           placeholder="Masukkan jumlah stok" value="{{ old('stok', $barang->stok) }}"
                                           required>
                                    @error('stok')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
